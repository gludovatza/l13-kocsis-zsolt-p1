...
<body>
    ...
    <nav>
        ...
        <ul id="menu">
            <li><a href="/" class="{{ request()->is('/') ? 'active' : '' }}">Kezdőoldal</a></li>
            <li><a href="/contact" class="{{ request()->is('contact') ? 'active' : '' }}">Kapcsolat</a></li>
            <li><a href="/pass-array" class="{{ request()->is('pass-array') ? 'active' : '' }}">Tömb adatainak küldése</a></li>
            <li><a href="/request-test?title=MyFirstTitle" class="{{ request()->is('request-test') ? 'active' : '' }}">Adatküldés URL segítségével</a></li>
            <li><a href="/posts/elso-bejegyzes" class="{{ request()->is('posts/elso-bejegyzes') ? 'active' : '' }}">Első blogbejegyzés</a></li>
        </ul>
    </nav>
    <!-- // -->
    <!-- Banner -->
